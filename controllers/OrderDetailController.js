...
exports.edit = (req, res, next) => {
  let sqlOrderDetail = knex('OrderDetail')
    .select('OrderDetail.order_id as "order_id"', 'OrderDetail.no as "no"', 'OrderDetail.product_id as "product_id"', 'OrderDetail.qty as "qty"')
...
exports.getDelete = (req, res, next) => {
  let sqlOrderDetail = knex('OrderDetail')
    ...
    .select('OrderDetail.order_id as "order_id"', 'OrderDetail.no as "no"', 'Product.name as "product_name"', 'OrderDetail.qty as "qty"')
    .where('OrderDetail.order_id', req.params.orderId)
    .where('OrderDetail.no', req.params.no)
    .toString()
